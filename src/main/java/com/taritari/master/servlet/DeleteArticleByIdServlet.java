...
import com.taritari.master.entity.BlogArticle;
 ...
 * @description
 */
@WebServlet("/article/deleteArticleById")
public class DeleteArticleByIdServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // 使用SQL语句删除数据
        String deleteSql = "DELETE FROM blog_article WHERE id = "+id;
